...
CS::CS() : name(""), workshops_count(0), workshops_working(0), type("") {}
CS::CS(std::string name, int workshops_count, int workshops_working, std::string type) : name(name), workshops_count(workshops_count), workshops_working(workshops_working), type(type) {}

std::ostream& operator<<(std::ostream& os, const CS& station) {
...
std::istream& operator>>(std::istream& is, CS& station) {
